...
---
## **SMS Health Check란?**
- [**SMS**](https://github.com/DMS-SMS)(School Management System)는 전공 동아리 [**DMS**](https://github.com/DSM-DMS)에서 개발하여 현재 운영하고 있는 **학교 지원 시스템**입니다.
...
---
## **Clean한 코드에 대해**
- 이번 프로젝트에서 저는 최대한 **Clean한 코드**를 짜기 위해 많은 노력을 하였습니다.

- 그럼 **Clean하다는 기준**은 무엇일까요? **제가 생각한 기준**은 다음과 같습니다.
    - 1
